...
myApp.controller('homeCtrl', function($scope,$stateParams,$http,$location,Search) {
  $scope.list_areas = {
    ...
    $scope.services = [
    { title: 'Logic Puzzles I', id: "Singing",img:'1.jpg' },
    { title: 'Logic Puzzles II', id: "Dancing",img:'2.jpg' },
    { title: 'Logic Puzzles III', id: "Yoga",img:'3.jpg' },
    { title: 'Logic Puzzles IV', id: "Gym",img:'4.jpg' },
